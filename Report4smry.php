...
class crReport4_summary extends crReport4 {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 'Report4');
...
//		$item->Visible = TRUE;
	...
	//		$rs->MoveFirst(); // NOTE: no need to move position
			if ($this->GrpCount == 1) {
				...
				$this->FirstRowData['ppn_nilai'] = ewr_Conv($rs->fields('ppn_nilai'),5);
		...
		if (!$rs->EOF) {
			...
			$this->ppn_nilai->setDbValue($rs->fields('ppn_nilai'));
			...
			$this->Val[4] = $this->ppn_nilai->CurrentValue;
	...
	function RenderRow() {
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL) { // Summary row
			...
			// ppn_nilai
			$this->ppn_nilai->ViewValue = $this->ppn_nilai->CurrentValue;
			$this->ppn_nilai->ViewValue = ewr_FormatNumber($this->ppn_nilai->ViewValue, 0, -2, -2, -1);
			$this->ppn_nilai->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";
			$this->ppn_nilai->CellAttrs["style"] = "text-align:right;";
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL) { // Summary row
			...
			// ppn_nilai
			$CurrentValue = $this->ppn_nilai->CurrentValue;
			$ViewValue = &$this->ppn_nilai->ViewValue;
			$ViewAttrs = &$this->ppn_nilai->ViewAttrs;
			$CellAttrs = &$this->ppn_nilai->CellAttrs;
			$HrefValue = &$this->ppn_nilai->HrefValue;
			$LinkAttrs = &$this->ppn_nilai->LinkAttrs;
	...
	function SetupFieldCount() {
		...
		if ($this->ppn_nilai->Visible) $this->DtlFldCount += 1;
	...
	function GetExtendedFilter() {
		...
		// Reset search command
			...
			if ($this->GetDropDownValue($this->tgl_invoice)) {
				$bSetupFilter = TRUE;
			} elseif ($this->tgl_invoice->DropDownValue <> EWR_INIT_VALUE && !isset($_SESSION['sv_Report4_tgl_invoice'])) {
				$bSetupFilter = TRUE;
			}
...
// Form object
var CurrentForm = fReport4summary = new ewr_Form("fReport4summary");
...
// Use Ajax
fReport4summary.Lists["sv_tgl_invoice"] = {"LinkField":"sv_tgl_invoice","Ajax":true,"DisplayFields":["sv_tgl_invoice","","",""],"ParentFields":[],"FilterFields":[],"Options":[],"Template":""};
</script>
<?php } ?>
<?php if ($Page->Export == "" && !$Page->DrillDown) { ?>
<script type="text/javascript">
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="tgl_invoice"><div class="Report4_tgl_invoice"><span class="ewTableHeaderCaption"><?php echo $Page->tgl_invoice->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="tgl_invoice">
<?php if ($Page->SortUrl($Page->tgl_invoice) == "") { ?>
		<div class="ewTableHeaderBtn Report4_tgl_invoice">
			<span class="ewTableHeaderCaption"><?php echo $Page->tgl_invoice->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer Report4_tgl_invoice" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->tgl_invoice) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->tgl_invoice->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="nama"><div class="Report4_nama"><span class="ewTableHeaderCaption"><?php echo $Page->nama->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="nama">
<?php if ($Page->SortUrl($Page->nama) == "") { ?>
		<div class="ewTableHeaderBtn Report4_nama">
			<span class="ewTableHeaderCaption"><?php echo $Page->nama->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer Report4_nama" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nama) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nama->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="no_kuitansi"><div class="Report4_no_kuitansi"><span class="ewTableHeaderCaption"><?php echo $Page->no_kuitansi->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="no_kuitansi">
<?php if ($Page->SortUrl($Page->no_kuitansi) == "") { ?>
		<div class="ewTableHeaderBtn Report4_no_kuitansi">
			<span class="ewTableHeaderCaption"><?php echo $Page->no_kuitansi->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer Report4_no_kuitansi" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->no_kuitansi) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->no_kuitansi->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="no_referensi"><div class="Report4_no_referensi"><span class="ewTableHeaderCaption"><?php echo $Page->no_referensi->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="no_referensi">
<?php if ($Page->SortUrl($Page->no_referensi) == "") { ?>
		<div class="ewTableHeaderBtn Report4_no_referensi">
			<span class="ewTableHeaderCaption"><?php echo $Page->no_referensi->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer Report4_no_referensi" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->no_referensi) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->no_referensi->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="ppn_nilai"><div class="Report4_ppn_nilai" style="text-align: right;"><span class="ewTableHeaderCaption"><?php echo $Page->ppn_nilai->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="ppn_nilai">
<?php if ($Page->SortUrl($Page->ppn_nilai) == "") { ?>
		<div class="ewTableHeaderBtn Report4_ppn_nilai" style="text-align: right;">
			<span class="ewTableHeaderCaption"><?php echo $Page->ppn_nilai->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer Report4_ppn_nilai" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->ppn_nilai) ?>',0);" style="text-align: right;">
			<span class="ewTableHeaderCaption"><?php echo $Page->ppn_nilai->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->ppn_nilai->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->ppn_nilai->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="total_ppn"><div class="Report4_total_ppn" style="text-align: right;"><span class="ewTableHeaderCaption"><?php echo $Page->total_ppn->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="total_ppn">
<?php if ($Page->SortUrl($Page->total_ppn) == "") { ?>
		<div class="ewTableHeaderBtn Report4_total_ppn" style="text-align: right;">
			<span class="ewTableHeaderCaption"><?php echo $Page->total_ppn->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer Report4_total_ppn" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->total_ppn) ?>',0);" style="text-align: right;">
			<span class="ewTableHeaderCaption"><?php echo $Page->total_ppn->FldCaption() ?></span>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_Report4_tgl_invoice"<?php echo $Page->tgl_invoice->ViewAttributes() ?>><?php echo $Page->tgl_invoice->GroupViewValue ?></span></td>
<?php } ?>
<?php if ($Page->nama->Visible) { ?>
		<td data-field="nama"<?php echo $Page->nama->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_Report4_nama"<?php echo $Page->nama->ViewAttributes() ?>><?php echo $Page->nama->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->no_kuitansi->Visible) { ?>
		<td data-field="no_kuitansi"<?php echo $Page->no_kuitansi->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_Report4_no_kuitansi"<?php echo $Page->no_kuitansi->ViewAttributes() ?>><?php echo $Page->no_kuitansi->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->no_referensi->Visible) { ?>
		<td data-field="no_referensi"<?php echo $Page->no_referensi->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_Report4_no_referensi"<?php echo $Page->no_referensi->ViewAttributes() ?>><?php echo $Page->no_referensi->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->ppn_nilai->Visible) { ?>
		<td data-field="ppn_nilai"<?php echo $Page->ppn_nilai->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_Report4_ppn_nilai"<?php echo $Page->ppn_nilai->ViewAttributes() ?>><?php echo $Page->ppn_nilai->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->total_ppn->Visible) { ?>
		<td data-field="total_ppn"<?php echo $Page->total_ppn->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_Report4_total_ppn"<?php echo $Page->total_ppn->ViewAttributes() ?>><?php echo $Page->total_ppn->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
...
<?php if ($Page->total_ppn->Visible) { ?>
		<td data-field="total_ppn"<?php echo $Page->total_ppn->CellAttributes() ?>>
<span data-class="tpgs<?php echo $Page->GrpCount ?>_Report4_total_ppn"<?php echo $Page->total_ppn->ViewAttributes() ?>><?php echo $Page->total_ppn->SumViewValue ?></span></td>
<?php } ?>
	</tr>
<?php
...
<?php if ($Page->total_ppn->Visible) { ?>
		<td data-field="total_ppn"<?php echo $Page->total_ppn->CellAttributes() ?>>
<span data-class="tpps_Report4_total_ppn"<?php echo $Page->total_ppn->ViewAttributes() ?>><?php echo $Page->total_ppn->SumViewValue ?></span></td>
<?php } ?>
	</tr>
<?php } ?>
<?php
...
<?php if ($Page->total_ppn->Visible) { ?>
		<td data-field="total_ppn"<?php echo $Page->total_ppn->CellAttributes() ?>>
<span data-class="tpts_Report4_total_ppn"<?php echo $Page->total_ppn->ViewAttributes() ?>><?php echo $Page->total_ppn->SumViewValue ?></span></td>
<?php } ?>
	</tr>
	</tfoot>
