...
$RootMenu->AddMenuItem(10020, "mmri_Report1", $Language->MenuPhrase("10020", "MenuText"), "Report1smry.php", -1, "{22C53325-0767-45B5-9478-ED427BDDCEC3}", TRUE, FALSE, FALSE);
$RootMenu->AddMenuItem(10024, "mmri_Report3", $Language->MenuPhrase("10024", "MenuText"), "Report3smry.php", -1, "{22C53325-0767-45B5-9478-ED427BDDCEC3}", TRUE, FALSE, FALSE);
$RootMenu->AddMenuItem(10022, "mmri_Report2", $Language->MenuPhrase("10022", "MenuText"), "Report2smry.php", -1, "{22C53325-0767-45B5-9478-ED427BDDCEC3}", TRUE, FALSE, FALSE);
$RootMenu->Render();
?>
<!-- End Main Menu -->
