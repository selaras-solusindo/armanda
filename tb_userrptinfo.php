...
//
class crtb_user extends crTableBase {
	var $user_id;
	var $username;
	var $password;
	var $userlevel;
	...
	function __construct() {
		...
		// user_id
		$this->user_id = new crField('tb_user', 'tb_user', 'x_user_id', 'user_id', '`user_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// username
		$this->username = new crField('tb_user', 'tb_user', 'x_username', 'username', '`username`', 200, EWR_DATATYPE_STRING, -1);
		...
		// password
		$this->password = new crField('tb_user', 'tb_user', 'x_password', 'password', '`password`', 200, EWR_DATATYPE_STRING, -1);
		...
		// userlevel
		$this->userlevel = new crField('tb_user', 'tb_user', 'x_userlevel', 'userlevel', '`userlevel`', 3, EWR_DATATYPE_NUMBER, -1);
