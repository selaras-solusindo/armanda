...
//		$item->Visible = TRUE;
	...
	function RenderRow() {
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL) { // Summary row
			...
			$this->total_ppn->SumViewValue = ewr_FormatNumber($this->total_ppn->SumViewValue, 2, -1, -1, -1);
			...
			$this->total_ppn->ViewValue = ewr_FormatNumber($this->total_ppn->ViewValue, 2, -1, -1, -1);
