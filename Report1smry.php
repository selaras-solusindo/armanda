...
class crReport1_summary extends crReport1 {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 'Report1');
...
//		$item->Visible = TRUE;
	...
	function RenderRow() {
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL) { // Summary row
			...
			$this->total_ppn->SumViewValue = ewr_FormatNumber($this->total_ppn->SumViewValue, 0, 0, 0, -1);
			...
			$this->total_ppn->ViewValue = ewr_FormatNumber($this->total_ppn->ViewValue, 0, 0, 0, -1);
	...
	function GetExtendedFilter() {
		...
		// Reset search command
			...
			if ($this->GetDropDownValue($this->tgl_invoice)) {
				$bSetupFilter = TRUE;
			} elseif ($this->tgl_invoice->DropDownValue <> EWR_INIT_VALUE && !isset($_SESSION['sv_Report1_tgl_invoice'])) {
				$bSetupFilter = TRUE;
			}
		...
		// Build SQL
		$this->BuildDropDownFilter($this->tgl_invoice, $sFilter, $this->tgl_invoice->DateFilter, FALSE, TRUE); // Field tgl_invoice
	...
	function ShowFilterList() {
		...
		$sExtWrk = "";
		$sWrk = "";
		$this->BuildDropDownFilter($this->tgl_invoice, $sExtWrk, $this->tgl_invoice->DateFilter);
		$sFilter = "";
		if ($sExtWrk <> "")
...
// Use Ajax
fReport1summary.Lists["sv_tgl_invoice"] = {"LinkField":"sv_tgl_invoice","Ajax":true,"DisplayFields":["sv_tgl_invoice","","",""],"ParentFields":[],"FilterFields":[],"Options":[],"Template":""};
</script>
<?php } ?>
<?php if ($Page->Export == "" && !$Page->DrillDown) { ?>
<script type="text/javascript">
...
<?php
	...
	for ($i = 0; $i < $cntd; $i++) {
		$selwrk = " selected";
?>
<option value="<?php echo $Page->tgl_invoice->DropDownList[$i] ?>"<?php echo $selwrk ?>><?php echo ewr_DropDownDisplayValue($Page->tgl_invoice->DropDownList[$i], $Page->tgl_invoice->DateFilter, 5) ?></option>
<?php
		$wrkcnt += 1;
	}
?>
...
<?php
$Page->tgl_invoice->LookupSql = "SELECT DISTINCT CONCAT(CAST(YEAR(`tgl_invoice`) AS CHAR(4)), '|', CAST(LPAD(MONTH(`tgl_invoice`),2,'0') AS CHAR(2))), CONCAT(CAST(YEAR(`tgl_invoice`) AS CHAR(4)), '|', CAST(LPAD(MONTH(`tgl_invoice`),2,'0') AS CHAR(2))) AS `DispFld` FROM `view3`";
$sWhereWrk = "";

// Call Lookup selecting
$Page->Lookup_Selecting($Page->tgl_invoice, $sWhereWrk);
if ($sWhereWrk <> "") $Page->tgl_invoice->LookupSql .= " WHERE " . $sWhereWrk;
$Page->tgl_invoice->LookupSql .= " ORDER BY CONCAT(CAST(YEAR(`tgl_invoice`) AS CHAR(4)), '|', CAST(LPAD(MONTH(`tgl_invoice`),2,'0') AS CHAR(2)))";
?>
<input type="hidden" name="s_sv_tgl_invoice" id="s_sv_tgl_invoice" value="s=<?php echo ewr_Encrypt($Page->tgl_invoice->LookupSql) ?>&amp;f0=<?php echo ewr_Encrypt("`tgl_invoice` = {filter_value}"); ?>&amp;t0=133&amp;ds=Month&amp;df=5&amp;dlm=<?php echo ewr_Encrypt($Page->tgl_invoice->FldDelimiter) ?>&amp;d="></span>
</div>
</div>
</div>
</form>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="tgl_invoice"><div class="Report1_tgl_invoice"><span class="ewTableHeaderCaption"><?php echo $Page->tgl_invoice->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="tgl_invoice">
<?php if ($Page->SortUrl($Page->tgl_invoice) == "") { ?>
		<div class="ewTableHeaderBtn Report1_tgl_invoice">
			<span class="ewTableHeaderCaption"><?php echo $Page->tgl_invoice->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer Report1_tgl_invoice" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->tgl_invoice) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->tgl_invoice->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="no_kuitansi"><div class="Report1_no_kuitansi"><span class="ewTableHeaderCaption"><?php echo $Page->no_kuitansi->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="no_kuitansi">
<?php if ($Page->SortUrl($Page->no_kuitansi) == "") { ?>
		<div class="ewTableHeaderBtn Report1_no_kuitansi">
			<span class="ewTableHeaderCaption"><?php echo $Page->no_kuitansi->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer Report1_no_kuitansi" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->no_kuitansi) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->no_kuitansi->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="no_invoice"><div class="Report1_no_invoice"><span class="ewTableHeaderCaption"><?php echo $Page->no_invoice->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="no_invoice">
<?php if ($Page->SortUrl($Page->no_invoice) == "") { ?>
		<div class="ewTableHeaderBtn Report1_no_invoice">
			<span class="ewTableHeaderCaption"><?php echo $Page->no_invoice->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer Report1_no_invoice" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->no_invoice) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->no_invoice->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="tgl_pelaksanaan"><div class="Report1_tgl_pelaksanaan"><span class="ewTableHeaderCaption"><?php echo $Page->tgl_pelaksanaan->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="tgl_pelaksanaan">
<?php if ($Page->SortUrl($Page->tgl_pelaksanaan) == "") { ?>
		<div class="ewTableHeaderBtn Report1_tgl_pelaksanaan">
			<span class="ewTableHeaderCaption"><?php echo $Page->tgl_pelaksanaan->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer Report1_tgl_pelaksanaan" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->tgl_pelaksanaan) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->tgl_pelaksanaan->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="total_ppn"><div class="Report1_total_ppn" style="text-align: right;"><span class="ewTableHeaderCaption"><?php echo $Page->total_ppn->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="total_ppn">
<?php if ($Page->SortUrl($Page->total_ppn) == "") { ?>
		<div class="ewTableHeaderBtn Report1_total_ppn" style="text-align: right;">
			<span class="ewTableHeaderCaption"><?php echo $Page->total_ppn->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer Report1_total_ppn" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->total_ppn) ?>',0);" style="text-align: right;">
			<span class="ewTableHeaderCaption"><?php echo $Page->total_ppn->FldCaption() ?></span>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_Report1_tgl_invoice"<?php echo $Page->tgl_invoice->ViewAttributes() ?>><?php echo $Page->tgl_invoice->GroupViewValue ?></span></td>
<?php } ?>
<?php if ($Page->nama->Visible) { ?>
		<td data-field="nama"<?php echo $Page->nama->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_Report1_nama"<?php echo $Page->nama->ViewAttributes() ?>><?php echo $Page->nama->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->no_kuitansi->Visible) { ?>
		<td data-field="no_kuitansi"<?php echo $Page->no_kuitansi->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_Report1_no_kuitansi"<?php echo $Page->no_kuitansi->ViewAttributes() ?>><?php echo $Page->no_kuitansi->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->no_invoice->Visible) { ?>
		<td data-field="no_invoice"<?php echo $Page->no_invoice->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_Report1_no_invoice"<?php echo $Page->no_invoice->ViewAttributes() ?>><?php echo $Page->no_invoice->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->no_sertifikat->Visible) { ?>
		<td data-field="no_sertifikat"<?php echo $Page->no_sertifikat->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_Report1_no_sertifikat"<?php echo $Page->no_sertifikat->ViewAttributes() ?>><?php echo $Page->no_sertifikat->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->tgl_pelaksanaan->Visible) { ?>
		<td data-field="tgl_pelaksanaan"<?php echo $Page->tgl_pelaksanaan->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_Report1_tgl_pelaksanaan"<?php echo $Page->tgl_pelaksanaan->ViewAttributes() ?>><?php echo $Page->tgl_pelaksanaan->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->total_ppn->Visible) { ?>
		<td data-field="total_ppn"<?php echo $Page->total_ppn->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_Report1_total_ppn"<?php echo $Page->total_ppn->ViewAttributes() ?>><?php echo $Page->total_ppn->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
...
<?php if ($Page->total_ppn->Visible) { ?>
		<td data-field="total_ppn"<?php echo $Page->total_ppn->CellAttributes() ?>>
<span data-class="tpgs<?php echo $Page->GrpCount ?>_Report1_total_ppn"<?php echo $Page->total_ppn->ViewAttributes() ?>><?php echo $Page->total_ppn->SumViewValue ?></span></td>
<?php } ?>
	</tr>
<?php
...
<?php if ($Page->total_ppn->Visible) { ?>
		<td data-field="total_ppn"<?php echo $Page->total_ppn->CellAttributes() ?>>
<span data-class="tpps_Report1_total_ppn"<?php echo $Page->total_ppn->ViewAttributes() ?>><?php echo $Page->total_ppn->SumViewValue ?></span></td>
<?php } ?>
	</tr>
<?php } ?>
<?php
...
<?php if ($Page->total_ppn->Visible) { ?>
		<td data-field="total_ppn"<?php echo $Page->total_ppn->CellAttributes() ?>>
<span data-class="tpts_Report1_total_ppn"<?php echo $Page->total_ppn->ViewAttributes() ?>><?php echo $Page->total_ppn->SumViewValue ?></span></td>
<?php } ?>
	</tr>
	</tfoot>
