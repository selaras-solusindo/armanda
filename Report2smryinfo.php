...
class crReport2 extends crTableBase {
	...
	function __construct() {
		...
		// nama
		$this->nama = new crField('Report2', 'Report2', 'x_nama', 'nama', '`nama`', 200, EWR_DATATYPE_STRING, -1);
		...
		// no_invoice
		$this->no_invoice = new crField('Report2', 'Report2', 'x_no_invoice', 'no_invoice', '`no_invoice`', 200, EWR_DATATYPE_STRING, -1);
		...
		// total_ppn
		$this->total_ppn = new crField('Report2', 'Report2', 'x_total_ppn', 'total_ppn', '`total_ppn`', 4, EWR_DATATYPE_NUMBER, -1);
