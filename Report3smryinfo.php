...
class crReport3 extends crTableBase {
	...
	function __construct() {
		...
		// no_kuitansi
		$this->no_kuitansi = new crField('Report3', 'Report3', 'x_no_kuitansi', 'no_kuitansi', '`no_kuitansi`', 200, EWR_DATATYPE_STRING, -1);
		...
		// no_sertifikat
		$this->no_sertifikat = new crField('Report3', 'Report3', 'x_no_sertifikat', 'no_sertifikat', '`no_sertifikat`', 200, EWR_DATATYPE_STRING, -1);
		...
		// customer_id
		$this->customer_id = new crField('Report3', 'Report3', 'x_customer_id', 'customer_id', '`customer_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// keterangan
		$this->keterangan = new crField('Report3', 'Report3', 'x_keterangan', 'keterangan', '`keterangan`', 201, EWR_DATATYPE_MEMO, -1);
		...
		// total
		$this->total = new crField('Report3', 'Report3', 'x_total', 'total', '`total`', 4, EWR_DATATYPE_NUMBER, -1);
