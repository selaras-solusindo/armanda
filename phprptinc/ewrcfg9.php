...
define("EWR_PROJECT_ID", "{22C53325-0767-45B5-9478-ED427BDDCEC3}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "armanda", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_armanda", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'h2ukISheo025EmS8', TRUE); // Random key for encryption
...
define("EWR_REPORT_DEFAULT_LOCALE", '{"decimal_point":".","thousands_sep":",","int_curr_symbol":null,"currency_symbol":null,"mon_decimal_point":".","mon_thousands_sep":",","positive_sign":null,"negative_sign":"-","int_frac_digits":2,"frac_digits":2,"p_cs_precedes":false,"p_sep_by_space":false,"n_cs_precedes":false,"n_sep_by_space":false,"p_sign_posn":3,"n_sign_posn":3}', TRUE);
...
// User admin
define("EWR_LOGIN_SELECT_SQL", "SELECT * FROM `tb_user`", TRUE);

// User table filters
define("EWR_USER_TABLE_DBID", "DB", TRUE);
define("EWR_USER_TABLE", "`tb_user`", TRUE);
...
define("EWR_TABLE_PREFIX", "{22C53325-0767-45B5-9478-ED427BDDCEC3}", TRUE);
