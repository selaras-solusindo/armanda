...
$tb_pelaksanaan_view = NULL; // Initialize page object first

class ctb_pelaksanaan_view extends ctb_pelaksanaan {
	...
	// Page object name
	var $PageObjName = 'tb_pelaksanaan_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["pelaksanaan_id"] <> "") {
				...
				$sReturnUrl = "tb_pelaksanaanlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tb_pelaksanaanlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "tb_pelaksanaanlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($tb_pelaksanaan_view)) $tb_pelaksanaan_view = new ctb_pelaksanaan_view();

// Page init
$tb_pelaksanaan_view->Page_Init();

// Page main
$tb_pelaksanaan_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tb_pelaksanaan_view->Page_Render();
?>
...
var CurrentForm = ftb_pelaksanaanview = new ew_Form("ftb_pelaksanaanview", "view");

// Form_CustomValidate event
ftb_pelaksanaanview.Form_CustomValidate = 
...
ftb_pelaksanaanview.ValidateRequired = true;
<?php } else { ?>
ftb_pelaksanaanview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($tb_pelaksanaan->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$tb_pelaksanaan_view->IsModal) { ?>
<?php if ($tb_pelaksanaan->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $tb_pelaksanaan_view->ExportOptions->Render("body") ?>
<?php
	foreach ($tb_pelaksanaan_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$tb_pelaksanaan_view->IsModal) { ?>
<?php if ($tb_pelaksanaan->Export == "") { ?>
...
<?php } ?>
<?php $tb_pelaksanaan_view->ShowPageHeader(); ?>
<?php
$tb_pelaksanaan_view->ShowMessage();
?>
<form name="ftb_pelaksanaanview" id="ftb_pelaksanaanview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tb_pelaksanaan_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tb_pelaksanaan_view->Token ?>">
<?php } ?>
...
<?php if ($tb_pelaksanaan->invoice_id->Visible) { // invoice_id ?>
	<tr id="r_invoice_id">
		<td><span id="elh_tb_pelaksanaan_invoice_id"><?php echo $tb_pelaksanaan->invoice_id->FldCaption() ?></span></td>
...
<?php echo $tb_pelaksanaan->invoice_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tb_pelaksanaan->pelaksanaan_tgl->Visible) { // pelaksanaan_tgl ?>
	<tr id="r_pelaksanaan_tgl">
		<td><span id="elh_tb_pelaksanaan_pelaksanaan_tgl"><?php echo $tb_pelaksanaan->pelaksanaan_tgl->FldCaption() ?></span></td>
...
<?php echo $tb_pelaksanaan->pelaksanaan_tgl->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($tb_pelaksanaan->Export == "") { ?>
<script type="text/javascript">
ftb_pelaksanaanview.Init();
</script>
<?php } ?>
<?php
$tb_pelaksanaan_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($tb_pelaksanaan->Export == "") { ?>
...
<?php
$tb_pelaksanaan_view->Page_Terminate();
?>
