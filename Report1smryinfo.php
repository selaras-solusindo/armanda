...
class crReport1 extends crTableBase {
	...
	function __construct() {
		...
		// nama
		$this->nama = new crField('Report1', 'Report1', 'x_nama', 'nama', '`nama`', 200, EWR_DATATYPE_STRING, -1);
		...
		// no_kuitansi
		$this->no_kuitansi = new crField('Report1', 'Report1', 'x_no_kuitansi', 'no_kuitansi', '`no_kuitansi`', 200, EWR_DATATYPE_STRING, -1);
		...
		// no_invoice
		$this->no_invoice = new crField('Report1', 'Report1', 'x_no_invoice', 'no_invoice', '`no_invoice`', 200, EWR_DATATYPE_STRING, -1);
		...
		// no_sertifikat
		$this->no_sertifikat = new crField('Report1', 'Report1', 'x_no_sertifikat', 'no_sertifikat', '`no_sertifikat`', 200, EWR_DATATYPE_STRING, -1);
		...
		// tgl_pelaksanaan
		$this->tgl_pelaksanaan = new crField('Report1', 'Report1', 'x_tgl_pelaksanaan', 'tgl_pelaksanaan', '`tgl_pelaksanaan`', 133, EWR_DATATYPE_DATE, -1);
		...
		// total_ppn
		$this->total_ppn = new crField('Report1', 'Report1', 'x_total_ppn', 'total_ppn', '`total_ppn`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// id
		$this->id = new crField('Report1', 'Report1', 'x_id', 'id', '`id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// customer_id
		$this->customer_id = new crField('Report1', 'Report1', 'x_customer_id', 'customer_id', '`customer_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// tgl_invoice
		$this->tgl_invoice = new crField('Report1', 'Report1', 'x_tgl_invoice', 'tgl_invoice', '`tgl_invoice`', 133, EWR_DATATYPE_DATE, -1);
		$this->tgl_invoice->GroupingFieldId = 1;
		$this->fields['tgl_invoice'] = &$this->tgl_invoice;
		$this->tgl_invoice->DateFilter = "Month";
		$this->tgl_invoice->SqlSelect = "";
		$this->tgl_invoice->SqlOrderBy = "";
		$this->tgl_invoice->FldGroupByType = "n";
		$this->tgl_invoice->FldGroupInt = "0";
		$this->tgl_invoice->FldGroupSql = "";

		// no_order
		$this->no_order = new crField('Report1', 'Report1', 'x_no_order', 'no_order', '`no_order`', 200, EWR_DATATYPE_STRING, -1);
		...
		// no_referensi
		$this->no_referensi = new crField('Report1', 'Report1', 'x_no_referensi', 'no_referensi', '`no_referensi`', 200, EWR_DATATYPE_STRING, -1);
		...
		// kegiatan
		$this->kegiatan = new crField('Report1', 'Report1', 'x_kegiatan', 'kegiatan', '`kegiatan`', 201, EWR_DATATYPE_MEMO, -1);
		...
		// keterangan
		$this->keterangan = new crField('Report1', 'Report1', 'x_keterangan', 'keterangan', '`keterangan`', 201, EWR_DATATYPE_MEMO, -1);
		...
		// total
		$this->total = new crField('Report1', 'Report1', 'x_total', 'total', '`total`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// ppn
		$this->ppn = new crField('Report1', 'Report1', 'x_ppn', 'ppn', '`ppn`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// terbilang
		$this->terbilang = new crField('Report1', 'Report1', 'x_terbilang', 'terbilang', '`terbilang`', 201, EWR_DATATYPE_MEMO, -1);
