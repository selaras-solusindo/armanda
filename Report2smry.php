...
// Form object
var CurrentForm = fReport2summary = new ewr_Form("fReport2summary");
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="nama"><div class="Report2_nama"><span class="ewTableHeaderCaption"><?php echo $Page->nama->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="nama">
<?php if ($Page->SortUrl($Page->nama) == "") { ?>
		<div class="ewTableHeaderBtn Report2_nama">
			<span class="ewTableHeaderCaption"><?php echo $Page->nama->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer Report2_nama" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nama) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nama->FldCaption() ?></span>
...
<?php if ($Page->SortUrl($Page->no_kuitansi) == "") { ?>
		<div class="ewTableHeaderBtn Report2_no_kuitansi">
			<span class="ewTableHeaderCaption"><?php echo $Page->no_kuitansi->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer Report2_no_kuitansi" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->no_kuitansi) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->no_kuitansi->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="no_invoice"><div class="Report2_no_invoice"><span class="ewTableHeaderCaption"><?php echo $Page->no_invoice->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="no_invoice">
<?php if ($Page->SortUrl($Page->no_invoice) == "") { ?>
		<div class="ewTableHeaderBtn Report2_no_invoice">
			<span class="ewTableHeaderCaption"><?php echo $Page->no_invoice->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer Report2_no_invoice" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->no_invoice) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->no_invoice->FldCaption() ?></span>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_Report2_no_invoice"<?php echo $Page->no_invoice->ViewAttributes() ?>><?php echo $Page->no_invoice->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->total_ppn->Visible) { ?>
...
<?php if ($Page->GrpFldCount + $Page->DtlFldCount > 0) { ?>
		<td colspan="<?php echo ($Page->GrpFldCount + $Page->DtlFldCount) ?>"<?php echo $Page->nama->CellAttributes() ?>><?php echo str_replace(array("%v", "%c"), array($Page->nama->GroupViewValue, $Page->nama->FldCaption()), $ReportLanguage->Phrase("RptSumHead")) ?> <span class="ewDirLtr">(<?php echo ewr_FormatNumber($Page->Cnt[1][0],0,-2,-2,-2) ?><?php echo $ReportLanguage->Phrase("RptDtlRec") ?>)</span></td>
<?php } ?>
</tr>
<?php
			$Page->ResetAttrs();
...
<?php } ?>
<?php if ($Page->no_invoice->Visible) { ?>
		<td data-field="no_invoice"<?php echo $Page->nama->CellAttributes() ?>>&nbsp;</td>
<?php } ?>
<?php if ($Page->total_ppn->Visible) { ?>
		<td data-field="total_ppn"<?php echo $Page->total_ppn->CellAttributes() ?>>
