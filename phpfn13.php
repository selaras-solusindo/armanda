...
function CurrentProjectID() {
	...
	return "{E6C293EF-4D71-4FC6-B668-35B8D3E752AB}";
}
...
function Database_Connecting(&$info) {
	...
	if (ew_CurrentUserIP () == "127.0.0.1"  || ew_CurrentUserIP () == ":: 1"  || ew_CurrentHost () == "localhost" ) { // testing on local PC
		...
		$info["db"] = "db_armanda"; // sesuaikan dengan nama database di komputer localhost
...
include_once($EW_RELATIVE_PATH . "phpmailer5216/PHPMailerAutoload.php");
