...
define("EW_PROJECT_NAME", "armanda", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{E6C293EF-4D71-4FC6-B668-35B8D3E752AB}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'yQzpugisp17T24hm', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/armanda.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_armanda", "qs" => "`", "qe" => "`");
...
define("EW_ADMIN_PASSWORD", "Duaribu16", TRUE); // Administrator password
...
// Page Title Style
define("EW_PAGE_TITLE_STYLE", "Breadcrumb", TRUE);
